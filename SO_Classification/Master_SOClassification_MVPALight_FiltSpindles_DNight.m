...
for subj = 1:numel(files_Cue_On)
    ...
    [EEGWhole, ~] = pop_eegfiltnew( EEGWhole, ...
    ...
    OUTEEG_CueSO_On = pop_epoch(EEGWhole,{'36'},[-1 1]);

    %-----Epoch the data for Vehicle On-------------
    OUTEEG_VehicleSO_On = pop_epoch(EEGWhole,{'46'},[-1 1]);
    ...
    save(char(strcat(savepath,'MVPA_SOClassification_OdorD_ValidEpochs_FiltSpindles')),'acc_All','acc','result_All','result');