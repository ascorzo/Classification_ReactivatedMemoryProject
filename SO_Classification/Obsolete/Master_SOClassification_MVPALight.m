...
addpath('/gpfs01/born/group/Andrea/MVPA-Light-master/startup')
startup_MVPA_Light
...
%% Vehicle 
    ...
    ft_CueSO_On= eeglab2fieldtrip(OUTEEG_CueSO_On,'raw');
    ft_CueSO_Off= eeglab2fieldtrip(OUTEEG_CueSO_Off,'raw');
    ft_VehicleSO_On= eeglab2fieldtrip(OUTEEG_VehicleSO_On,'raw');
    ft_VehicleSO_Off= eeglab2fieldtrip(OUTEEG_VehicleSO_Off,'raw');
...
%             AllSubj);
%         
%     save(strcat('AllSubj_CueOnvsVehOn_50cv'),'Results','Accuracies')
