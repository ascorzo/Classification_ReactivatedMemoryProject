...
%----For Cue Night:
load('D:\GermanData\SOClassification\20-Feb-2021_AllData_Cue_Night\20-Feb-2021_21-26-16_AllData.mat')
filesDavidPath  = 'D:\GermanData\DATA\EpochedDavid\';
...
for file_DA = files_DA_Cue
    ...
    [EEGDavidCue] = load(...
        strcat(filesDavidPath,char(file_DA),'_TRIALS_OFF_ON_Odor.mat'));  
    
    [EEGDavidVehicle] = load(...
        strcat(filesDavidPath,char(file_DA),'_TRIALS_OFF_ON_Sham.mat')); 
