...
for i = 1:30 %numel(files_Cue_Off)
    ...
    filename = strcat(file_Cue_On(1:7),'OnOff_CuevsSham');
    
    EEGCue = cat(3,EEGCueOn.data,EEGCueOff.data);
    EEGSham = cat(3,EEGShamOn.data,EEGShamOff.data);
