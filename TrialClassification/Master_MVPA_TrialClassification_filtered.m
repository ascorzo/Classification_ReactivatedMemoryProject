...
for subj  = 1:numel(filesOdor)
    ...
    %----------Filter Datasets around 2.5Hz--------------------
    cfg                 = [];
    cfg.bpfilter        = 'yes';
    cfg.bpfreq          = [2 3];


    ft_EEG_OdorD_SwitchedOn     = ft_preprocessing(cfg, ft_EEG_OdorD_SwitchedOn);
    ft_EEG_OdorD_SwitchedOff    = ft_preprocessing(cfg, ft_EEG_OdorD_SwitchedOff);
    ft_EEG_VehicleD_SwitchedOn  = ft_preprocessing(cfg, ft_EEG_VehicleD_SwitchedOn);
    ft_EEG_Vehicle_SwitchedOff  = ft_preprocessing(cfg, ft_EEG_Vehicle_SwitchedOff);
...
save(char(strcat(savepath,'svm_Classification_OdorDNight_AllFeatures_OdorvsVehicle_Filtered')),'acc_All','Accuracy');
