...
%for cluster = 1:numel(clusters)
    ...
    save(char(strcat(savepath,'TimeSegments_OdorMNight_SVM_Smaller')),'acc_All','acc');


    %save(char(strcat(savepath,'TimeSegments_OdorMNight_SVM_Classification_',clusters{cluster})),'acc_All','acc');
